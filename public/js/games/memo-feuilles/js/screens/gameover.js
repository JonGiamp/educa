game.GameoverScreen = me.ScreenObject.extend({
	...
	onResetEvent: function() {
		...
		sendScore(600+(40-game.data.moves)*50);
        ...
        renderer.fillRect(this.pos.x, this.pos.y, this.width, this.height);
				this.font.draw(renderer, "Bravo !", me.game.viewport.width/2, me.game.viewport.height/2-96);
				this.font.draw(renderer, "Tu as tout trouvé en "+game.data.moves+" coups.\n\nCela te fait un total de\n"+(600+(40-game.data.moves)*50)+" points !", me.game.viewport.width/2, me.game.viewport.height/2-16);
			},
		...
		me.game.world.addChild(new smallButton(8+3*me.game.viewport.width/4,me.game.viewport.height-56,me.game.viewport.width/4-16,48,"#ffca28","#DDD","Retour au menu",backButtonCallback),2);
	},
