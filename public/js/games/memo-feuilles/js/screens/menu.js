game.TitleScreen = me.ScreenObject.extend({
  ...
  onResetEvent : function () {
		...
		me.game.world.addChild(new menuLink(me.game.viewport.width/4,me.game.viewport.height/2+32,"#333","#EC9","Jouer",playButtonCallback));
		...
		me.game.world.addChild(new (me.Renderable.extend ({
			...
			init : function () {
				...
				// fonts
				this.titleFont = new me.Font("Arial", 48, '#ffca28', "center");
			},

			draw : function (renderer) {
				this.titleFont.draw(renderer, "Mémo-feuilles", me.game.viewport.width/2, me.game.viewport.height/2-144);
			},
		})), 2);
